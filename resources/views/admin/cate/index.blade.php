  ...
  <body>
      ...
      <table class="layui-table layui-form">
        ...
        <tbody class="x-cate">
          ...
          <tr cate-id="{{$v['id']}}" fid="{{$v['pid']}}" >
            ...
            <td>
              <input type="text" class="layui-input x-sort" lay-filter="sort" name="sort" 
              onchange="changesort(this,'{{$v['id']}}')" value="{{$v['sort']}}">
            </td>
            <td>
            ...
            <td class="td-manage">
              <button class="layui-btn layui-btn layui-btn-xs"  onclick="x_admin_show('编辑','{{url('admin/cate/'.$v['id'].'/edit')}}')" >
                <i class="layui-icon">&#xe642;</i>编辑
              </button>
              <button class="layui-btn layui-btn-warm layui-btn-xs"  onclick="x_admin_show('添加子栏目','{{url('admin/cate/createson/'.$v['id'].'/'.$v['level'].'')}}')" >
    ...
    <script>
      ...
      function changesort(obj,id){
          $.get('/admin/cate/sort/'+id+'/'+obj.value,function(res){
            if (res.code == 200) {
              layer.msg(res.info,{icon:6,time:2000});
            }else{
              layer.msg(res.info,{icon:5,time:2000});
